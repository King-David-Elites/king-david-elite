    ...
    <Container ref={top}>
      ...
      <div className="cont">
        ...
        <p>
          ...
          <p className="inline">
            Our website refers to the website under the domain <span className="text-theme-color cursor-pointer" onClick={() => navigate(window.location.replace("https://kingdavidelites.com"))}>kingdavidelites.com</span> and any subdomain;
          </p>
        ...
        <p>
          ...
          <p className="inline">
            8.1 To the extent that KDE processes any personal data provided by you in connection with this Agreement, KDE will do so in accordance with KDE’s privacy statement as set out at <span className="text-theme-color cursor-pointer" onClick={() => navigate(window.location.replace("https://kingdavidelites.com"))}>kingdavidelites.com</span>   and in accordance with any applicable data protection laws of KDE’s current countries of operations, being Nigeria.
          </p>
        ...
        <p>
          <b>10. NOTICE  </b>
          <p className="inline">
            10.1 If You wish to provide notice under this Agreement, such notice must be sent to <span className="text-theme-color cursor-pointer">kingdavidelites@gmail.com.</span>
          </p>
        ...
        <p>
          ...
          <p className="inline">
            16.1  If You have any questions relating to these Terms of Use, your rights and obligations arising from these Terms of Use and/or your use of the Platform, please contact us via email at <span className="text-theme-color cursor-pointer">kingdavidelites@gmail.com.</span>
          </p>
