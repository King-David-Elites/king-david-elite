...
// import { Leftwallet } from "./Otp.style";
// import { Rightwallet } from "./Otp.style";
...
//             <button className='transfer'>Withdraw</button>
...
//            <p>We have sent an OTP to your email and mobile number inorder to validate transfer   </p>
//             <h6>Enter OTP</h6>
//            <input placeholder='000  00 '/>
//            <input className="leftinput" placeholder='Re-send'/>
