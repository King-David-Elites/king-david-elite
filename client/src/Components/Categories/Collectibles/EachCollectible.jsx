      ...
      <EachContainer ref={top}>
        ...
        <div className="images">
          ...
          <div className="grid">
            <img src={data?.img} alt="" />
            <img src={data?.img} alt="" />
            <img src={data?.img} alt="" loading="loading..." />
          </div>
          <p>
            Listed <p>just Now</p>
          </p>
        ...
        <div className="flex">
          <div className="details">
            <h3>Description</h3>
            <p className="py-[20px] px-0 text-[#696969]">
              Lorem ipsum dolor sit amet consectetur. Sagittis eget etiam proin
              ut molestie mi in diam venenatis. Sollicitudin neque id montes
              orci et tellus. Fames convallis eget et consectetur. Erat ornare
              ullamcorper nisl condimentum donec congue arcu fermentum semper.
              Commodo in sagittis nunc risus. Sollicitudin tellus amet neque et
              enim enim.
            </p>
          </div>
        </div>
