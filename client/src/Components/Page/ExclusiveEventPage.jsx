        ...
        <div className=" w-full h-[100vh] bg-white md:py-8 px-24 relative">
            <div className='h-[95%]'>
                ...
                <div className='flex md:gap-5 mt-5 items-center'>
                    <p className='font-semibold text-2xl'>Exclusive Events</p>
                ...
                >
                    {formik => (
                        <Form>
                            ...
                            <div className="flex md:gap-4 font-semibold">
                ...
                <div className='w-[350px] h-[100vh] fixed top-0 right-36 bottom-0'>
